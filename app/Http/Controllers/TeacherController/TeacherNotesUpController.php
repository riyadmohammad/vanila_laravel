...
class TeacherNotesUpController extends Controller
{
    /**
    ...
    {
        $course=Course::all();
        return view('teacher.teacherNotesUpload',compact('course'));
    }
