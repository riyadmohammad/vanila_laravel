...
class TeacherAlertParentController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('teacher.teacherAlertParent', compact('data'));
    }
    ...
    public function show($id)
    {
        ...
        return view('teacher.teacherMailSend', compact('data'));
    }
